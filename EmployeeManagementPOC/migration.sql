...
VALUES (1, N'Information Technology', N'IT'),
(2, N'Human Resources', N'HR'),
(3, N'Finance Department', N'Finance');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Description', N'Name') AND [object_id] = OBJECT_ID(N'[Departments]'))
...
VALUES (N'20260815121014_InitialCreate', N'10.0.11');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260815130357_Add_Identity', N'10.0.11');
